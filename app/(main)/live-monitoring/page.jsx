...
import DeviceLocationMap from "./map";
...
export default function LiveMonitoring() {
    ...
    const connectSSE = () => {
      ...
      eventSource.onmessage = (event) => {
        ...
        if (data.type === "initial") {
          ...
          // Only add new events if on page 1, otherwise ignore for pagination consistency
  ...
  }, [isMounted, appliedFilters, filters.page]); // Reconnect on page change
