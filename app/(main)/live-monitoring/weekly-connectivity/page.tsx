...
export default function WeeklyConnectivityPage() {
  ...
  const handleExportWeekCSV = async () => {
    ...
    try {
      ...
      const a = Object.assign(document.createElement("a"), { href: URL.createObjectURL(blob), download: `weekly_connectivity_${weekStart}.csv`, style: "visibility:hidden" });
